...
const D = [
  ...
  {id:"26_08_1",t:2026,f:8,d:"2026-05-16",local:"Champagnat",pL:9,pV:30,visitante:"Los Matreros",bL:false,bV:true},
  {id:"26_08_2",t:2026,f:8,d:"2026-05-16",local:"Alumni",pL:17,pV:23,visitante:"Hindú",bL:false,bV:false},
  {id:"26_08_3",t:2026,f:8,d:"2026-05-16",local:"Newman",pL:16,pV:15,visitante:"La Plata",bL:false,bV:false},
  {id:"26_08_4",t:2026,f:8,d:"2026-05-16",local:"SIC",pL:39,pV:21,visitante:"Regatas",bL:false,bV:false},
  {id:"26_08_5",t:2026,f:8,d:"2026-05-16",local:"Belgrano Ath.",pL:27,pV:21,visitante:"Atl. del Rosario",bL:false,bV:false},
  {id:"26_08_6",t:2026,f:8,d:"2026-05-16",local:"Buenos Aires",pL:22,pV:48,visitante:"Los Tilos",bL:false,bV:true},
  {id:"26_08_7",t:2026,f:8,d:"2026-05-16",local:"CUBA",pL:37,pV:38,visitante:"CASI",bL:false,bV:false},
];
...
// ── CONTEXTO ESPN + RUGBY CHAMPAGNE POR PARTIDO ─────────────────
// ESPN: resultado_engañoso, motivo, amarillas
// champagne: análisis táctico de Rugby Champagne
const CONTEXTO_PARTIDOS = {
  // FECHA 1
  "26_01_0": { engañoso:"PARCIAL", motivo:"Inicio parejo 20min, diferencia real en 2T. Try penal.", amarillasL:0, amarillasV:1, champagne:null },
  "26_01_1": { engañoso:"SÍ", motivo:"CASI dominó el 1T (28-9). Champagnat dominó el 2T. 2 amarillas Champa, 2 CASI.", amarillasL:2, amarillasV:2, champagne:null },
  "26_01_2": { engañoso:"NO", motivo:"Newman genuinamente superior. Sin tarjetas determinantes.", amarillasL:0, amarillasV:0, champagne:null },
  "26_01_3": { engañoso:"SÍ", motivo:"CUBA ganaba 10-0 y 25-20. Alumni ganó en última jugada (try Wagener).", amarillasL:0, amarillasV:0, champagne:null },
  "26_01_4": { engañoso:"SÍ", motivo:"La Plata llegó a ir 24-23. Nogués 7/8 patadas definió el partido.", amarillasL:0, amarillasV:0, champagne:null },
  "26_01_5": { engañoso:"PARCIAL", motivo:"Amarilla temprana a García Dragui amplificó margen. SIC igual superior.", amarillasL:0, amarillasV:1, champagne:null },
  "26_01_6": { engañoso:"SÍ", motivo:"Regatas llegó a ganar 26-24. Matreros ganó con penal en tiempo cumplido.", amarillasL:0, amarillasV:0, champagne:null },
  // FECHA 2
  "26_02_0": { engañoso:"SÍ", motivo:"Matreros llegó a ganar 17-20. Perdió por amarilla a Romanato.", amarillasL:0, amarillasV:1, champagne:null },
  "26_02_1": { engañoso:"SÍ", motivo:"Belgrano dominó el 1T. Newman dio vuelta en 2T jugando con uno menos.", amarillasL:1, amarillasV:0, champagne:null },
  "26_02_2": { engañoso:"NO", motivo:"Regatas genuinamente superior. Landivar 3 tries de line-maul.", amarillasL:1, amarillasV:0, champagne:null },
  "26_02_3": { engañoso:"SÍ", motivo:"La Plata dominó 1T con viento (13-3). Los Tilos dominó 2T.", amarillasL:0, amarillasV:0, champagne:null },
  "26_02_4": { engañoso:"SÍ", motivo:"CASI estuvo arriba 12-8 en el 2T. Hindú ganó con try en min 78.", amarillasL:0, amarillasV:0, champagne:null },
  "26_02_5": { engañoso:"SÍ", motivo:"BsAs 2 amarillas, Alumni 2 amarillas. Definido por penales de Bunge.", amarillasL:2, amarillasV:2, champagne:null },
  "26_02_6": { engañoso:"SÍ", motivo:"Champagnat 4 amarillas, CUBA 3 amarillas. Ganó el menos indisciplinado.", amarillasL:3, amarillasV:4, champagne:null },
  // FECHA 3
  "26_03_0": { engañoso:"SÍ", motivo:"Belgrano llegó a ganar 21-19. Alumni respondió con try de Fuentes al final.", amarillasL:1, amarillasV:2, champagne:null },
  "26_03_1": { engañoso:"SÍ", motivo:"Los Tilos dominó el 2T (22-20). Regatas ganó por robo individual de Pisani.", amarillasL:0, amarillasV:0, champagne:null },
  "26_03_2": { engañoso:"SÍ", motivo:"1T cerrado (13-3). CASI anotó 3 tries en ráfaga en min 60.", amarillasL:0, amarillasV:0, champagne:null },
  "26_03_3": { engañoso:"SÍ", motivo:"CUBA fue arriba al descanso 19-17. Hindú dio vuelta en 2T. Try penal en última jugada.", amarillasL:0, amarillasV:0, champagne:null },
  "26_03_4": { engañoso:"SÍ", motivo:"Partido muy cerrado. Amarilla a Basualdo Quintana generó try penal.", amarillasL:0, amarillasV:1, champagne:null },
  "26_03_5": { engañoso:"SÍ", motivo:"Atl. del Rosario llegó a estar ganando en 2T. Matreros reaccionó en últimos 6 minutos.", amarillasL:0, amarillasV:0, champagne:null },
  "26_03_6": { engañoso:"PARCIAL", motivo:"1T muy parejo. SIC dominó el 2T con Albanese figura.", amarillasL:0, amarillasV:0, champagne:null },
  // FECHA 4
  "26_04_0": { engañoso:"SÍ", motivo:"Partido trabado al inicio. Newman destrancó con 2 tries. Matreros compitió gran parte.", amarillasL:0, amarillasV:0, champagne:"1T parejo. Newman destrancó con 2 tries consecutivos. Los Matreros reaccionó y volvió a meterse en partido. Ambos siguieron anotando → descanso parejo. 2T: Los Matreros estuvo en partido hasta penal Morales (21-21 min 5 del 2T). Luego Newman impuso jerarquía en el tramo final y selló con abrumadora diferencia 52-28. Patrón Newman: equipo de 2T con recursos para el cierre." },
  "26_04_1": { engañoso:"NO", motivo:"SIC fue genuinamente mejor. Sascaro y Silva con amarilla pero SIC resistió.", amarillasL:2, amarillasV:0, champagne:"SIC jugó de local en Tortuguitas por suspensión de cancha. 1T: Canzani 2 penales (Alumni 6-0). Sascaro descontó (6-3). Fernández De Oliveira try → SIC al frente (10-6). Bottoni try Alumni (13-10). Sascaro penal → empate 13-13 al descanso. 2T: Alumni arrancó mejor con Canzani al pie + try Neyra (20-13). SIC reaccionó: Rocha try + apertura igualó (23-23). Rocha segundo try → SIC 30-23. Amarilla a Sascaro pero SIC resistió. López Fleming penal → 33-23 final." },
  "26_04_2": { engañoso:"SÍ", motivo:"La Plata dominó 1T (25-7). CUBA reaccionó en 2T y casi da vuelta.", amarillasL:0, amarillasV:0, champagne:"Ambos llegaban con 3 derrotas. 1T: CUBA abrió con try Cardini. La Plata golpeó con doblete Paz Rizzoli + try Di Lucca + 2 penales → La Plata 25-7 al descanso. 2T: CUBA salió con otra actitud. Tries Castro Nevares, Panigatti, Ortiz de Rosas, Passaro y De la Vega (todos Benedit) para llegar a 33-32. La Plata defendió con penal Suárez Folch → 35-33. Primera victoria de La Plata." },
  "26_04_3": { engañoso:"NO", motivo:"Hindú genuinamente superior. BsAs: amarilla Herrador + amarilla Lamensa. Hindú: roja 20' Cancelliere.", amarillasL:1, amarillasV:2, champagne:"1T muy físico. Amarilla a Herrador (BsAs) temprano → Hindú aprovechó superioridad numérica. Ormaechea 3 tries + 3 conversiones en el 1T. BsAs descontó con penal Bunge → 21-9 al descanso. 2T: Expulsión de Cancelliere (Hindú) → Hindú con 14 jugadores todo el 2T. BsAs no pudo aprovechar el hombre de más y sufrió el pack rival. Rodríguez try + conv Ormaechea → 34-12. Hindú ganó siendo inferior numéricamente." },
  "26_04_4": { engañoso:"SÍ", motivo:"Belgrano dominó 1T. Indisciplina lo mató. Champagnat ganó con drop en último minuto.", amarillasL:2, amarillasV:0, champagne:"Belgrano dominó el 1T con superioridad del pack (19-13 al descanso). 2T: Champagnat mejoró el juego de manos y encontró espacios. Llegaron igualados 24-24 al final. Drop de Santos Panelo + penal Costaguta → Champagnat 30-24. Tries Belgrano: Arana, Vaccarino, Etchepare, Solveyra + 2 conv Landó. Tries Champagnat: Rodríguez Navarro y J.S. Panelo + 5 penales y 1 conv Costaguta. Belgrano 0 victorias en 4 fechas." },
  "26_04_5": { engañoso:"SÍ", motivo:"Regatas indisciplinado en 2T. CASI aprovechó para sentenciar.", amarillasL:0, amarillasV:2, champagne:"CASI hizo de local en Bella Vista. Partido parejo hasta min 56 del 2T (17-14 CASI). La indisciplina de Regatas fue determinante: 3 amarillas (Camerlinckx min 16, De la Torre min 56, Barbaccia min 71). Cada amarilla capitalizada por CASI. 1T: try Sanguinetti Regatas → penales Akemeier + try Phelan → CASI 17-14 al descanso. 2T: parejo hasta min 56. Luego tries Torres Obeid, Solveyra y Akemeier sobre las amarillas. Figura: Akemeier 23 puntos." },
  "26_04_6": { engañoso:"NO", motivo:"Atl. del Rosario fue levemente mejor. Sin tarjetas determinantes.", amarillasL:0, amarillasV:0, champagne:"Partido palo a palo con 5 tries por lado. 1T: Los Tilos abrió con try Fernández Armendariz. Plaza reaccionó con try Bertero. Los Tilos volvió a marcar. Plaza cerró el 1T con tries Bertero x2 y Malanos → Plaza 29-17 al descanso. 2T: Plaza dominó el scrum, sólido en formaciones fijas y forzó penales. Los Tilos ofreció resistencia pero la indisciplina en momentos críticos le impidió acercarse. Nogués penal sobre la hora selló 39-32. Figura: Nogués 14 puntos." },
  // FECHA 5
  "26_05_0": { engañoso:"SÍ", motivo:"Matreros dominó gran parte. Los Tilos anotó 2 tries en últimos 10 minutos.", amarillasL:0, amarillasV:0, champagne:"Los Matreros arrancó con try Michero (min 2). Los Tilos reaccionó con try López Feybli + try Rodríguez Alcobendas + penal Santamarina → Los Tilos 17-10 al descanso. 2T: Los Matreros tomó el ritmo y dio vuelta con try Hardt + penales Morales + try Amorisa (23-17). Los Tilos no bajó los brazos: en 10 minutos Santamarina y Tuculet apoyaron para dar vuelta nuevamente y sentenciar 32-23." },
  "26_05_1": { engañoso:"SÍ", motivo:"Ida y vuelta constante. Scaiano amarilla en 1T, Phelan amarilla en 2T. Atl. del Rosario bonus defensivo.", amarillasL:1, amarillasV:1, champagne:"1T intenso y parejo. Plaza arrancó con try Reyes (maul). CASI respondió rápido. Atl. del Rosario dio vuelta con tries Bertero y Rubio + Nogués al pie → Plaza 22-14 al descanso. 2T: CASI sacó efectividad con peso del pack. 3 tries en 26 minutos para tomar la delantera. Solveyra y Torres Obeid figuras. Plaza se mantuvo con penales de Nogués pero no alcanzó. A Plaza le faltó contundencia defensiva en los momentos críticos del 2T." },
  "26_05_2": { engañoso:"NO", motivo:"Partido trabado. CUBA se acercó a 3 puntos al final. Sin tarjetas determinantes.", amarillasL:0, amarillasV:0, champagne:"1T parejo con predominio del pie. CUBA abrió con try Mastroizzi (min 16). Regatas empató con try De la Torre (min 39) → CUBA 10-9 al descanso. 2T: Regatas dio vuelta con try Benedit (min 19) + De la Torre amplió. CUBA se acercó a 3 puntos al cierre y buscó hasta el final pero no lo logró. CUBA con 5 derrotas consecutivas." },
  "26_05_3": { engañoso:"SÍ", motivo:"BsAs 2 amarillas seguidas. La Plata 2 amarillas. BsAs ganó solo con penales de Bunge.", amarillasL:2, amarillasV:2, champagne:"La Plata arrancó mejor: try De la Fuente (7-0). BsAs respondió con try Handley (7-5). La Plata volvió a estirar con penal Suárez Folch + try Chiappani (17-5). BsAs reaccionó con tries Prieto y Bourdal para dar vuelta → BsAs 19-17 al descanso. 2T: juego cerrado y táctico. Suárez Folch 2 penales para La Plata, Bunge respondió para BsAs. BsAs sostuvo la diferencia y ganó 25-23." },
  "26_05_4": { engañoso:"SÍ", motivo:"Belgrano iba ganando 15-13 al descanso. Belgrano 4 amarillas. Hindú 1 amarilla.", amarillasL:1, amarillasV:4, champagne:"Marcador parejo hasta los 20min del 2T. Belgrano pudo concretar sus oportunidades y se fue arriba al descanso 15-13. 2T: Hindú propuso buen juego y aprovechó las inconductas de Belgrano. 4 tries en la segunda etapa. Tries Hindú: N.Amaya x2, Capurro x2, S.Amaya + Ormaechea 2 penales y 4 conversiones. Tries Belgrano: Fossati, Vaccarino x2 + penal y 2 conversiones Landó. 5ta victoria consecutiva de Hindú." },
  "26_05_5": { engañoso:"PARCIAL", motivo:"SIC dominó 1T. Champagnat 2 amarillas simultáneas amplificaron margen.", amarillasL:0, amarillasV:2, champagne:"SIC jugó casi perfecto en el 1T con scrum demoledor. Abrió con try penal. Champagnat recibió 2 amarillas casi simultáneas → SIC aprovechó con try Meyrelles. 2T: Silva apoyó tercera conquista para SIC. Champagnat descontó con try Rufino pero no alcanzó ante la supremacía rival. SIC invicto, escolta de Hindú a 1 punto." },
  "26_05_6": { engañoso:"NO", motivo:"Newman ganó con 1 amonestado (Gutiérrez Taboada). Clutch confirmado.", amarillasL:0, amarillasV:1, champagne:"Alumni dominó el 1T hasta el 17-3 (tries Neyra y Alduncin). Newman reaccionó con tries Salese y Ortiz Basualdo → empate 17-17 al descanso. 2T: ida y vuelta constante. Try Anderson (Alumni 22-17) → try Vela (22-22) → penal Canzani (25-22) → penal Taboada (25-25) → try Lozano + conversión Taboada (25-32 Newman). Alumni descontó con try Lamelas (30-32). Taboada amarilla min 31 pero Alumni no pudo aprovechar. Newman resistió con la defensa. Figura: Ortiz Basualdo 2 tries." },
  // FECHA 6
  "26_06_1": { engañoso:"SÍ", motivo:"Partido trabado. Amarilla a Marelli (Alumni) a los 57' fue el quiebre. Matreros aprovechó.", amarillasL:0, amarillasV:1, champagne:"1T: Alumni arriba 10-6 sin haber sido mejor. Alumni apático, Los Matreros con más posesión. Canzani penal (3-0), Morales igualó y pasó al frente (3-6), Bivort try + Canzani (10-6). 2T: Los Matreros mejor a medida que pasaban los minutos. Try Córdoba + penal Morales → LM 16-10. Amarilla a Marelli (LM) → Alumni presionó pero solo un penal (13-16). Try y conversión Morales → 23-13. Bivort try descontó (18-23). Figura: Morales 18pts. LM ganó con amarillas propias sin que Alumni las aprovechara." },
  "26_06_2": { engañoso:"NO", motivo:"Newman dominó con claridad. Champagnat amarilla a Alonso Boto.", amarillasL:1, amarillasV:1, champagne:"Newman dominó desde el inicio. 2 penales Taboada para arrancar. Champagnat descontó con penal pero amarilla a Alonso Boto fue el quiebre. Tries Salese y Taboada con superioridad numérica. Champagnat descontó con try Bottazzi al final del 1T (23-8). 2T algo desprolijo pero Newman mantuvo superioridad: try Lozano (pack), try Prince. Últimos 8 minutos: Cardinal y Longinotti sellaron bonus 47-8. Taboada figura con 22 puntos." },
  "26_06_3": { engañoso:"NO", motivo:"Partido palo a palo. SIC tuvo a Rocha con amarilla. Hindú ganó con try de line-maul en tiempo cumplido.", amarillasL:0, amarillasV:1, champagne:"Partido de alto vuelo golpe por golpe. SIC arrancó con try Silva. Hindú dio vuelta con penales Ormaechea + try Álvarez. Amarilla a Rocha (SIC) pero Sascaro penales pusieron al SIC arriba. Try Graglia (Hindú) vs try Silva → descanso 20-15 SIC. 2T: try Ezcurra → Hindú arriba. Sascaro penal + try Plorutti → SIC 31-27. Amher try acercó a Hindú (28-27). Hindú con 13 jugadores (amarillas Aranoa y Rodríguez). Sascaro penal → SIC 31-27. Última jugada: line y maul → try Santino Amaya en tiempo cumplido → Hindú 32-31. Primer triunfo Hindú ante SIC en 4 años." },
  "26_06_4": { engañoso:"NO", motivo:"La Plata anotó primero en 2T. Belgrano respondió con 2 tries en 3 minutos.", amarillasL:0, amarillasV:0, champagne:"1T: Belgrano arriba con penales Landó + try Tecca (10-0). Suárez Folch patadas → La Plata al frente 12-10 al descanso. 2T: La Plata arrancó mejor con try Cejas + Suárez Folch amplió (19-10). Backs de Belgrano reaccionaron con tries Navarro y Fossati en 3 minutos para dar vuelta el partido. Landó 2 penales más + conversión para sellar 28-19. Primera victoria de Belgrano en la temporada tras 5 derrotas seguidas." },
  "26_06_5": { engañoso:"NO", motivo:"Regatas superior en contacto. BsAs amarilla a Zanella en 1T.", amarillasL:0, amarillasV:1, champagne:"Regatas dominó físicamente de principio a fin con superioridad en formaciones fijas. BsAs sufrió en el scrum con penales de Zanella + amarilla antes del descanso. Regatas siempre al frente (parcial 20-13). BsAs se acercó con try Lamensa + conversión Bunge (23-25). En el final Regatas aseguró con try penal para llevarse el bonus. BsAs presionó con uno menos pero no alcanzó." },
  "26_06_6": { engañoso:"PARCIAL", motivo:"Amarilla a Elías (Atl. Rosario) permitió primeros tries de CUBA. En 2T CUBA fue claramente mejor.", amarillasL:0, amarillasV:1, champagne:"1T parejo. Plaza abrió con penal Nogués. Amarilla a Elías (Plaza) → CUBA aprovechó con tries Cayol y De la Vega + Benedit (14-3). Con 15 Atl. del Rosario descontó con try Capella + Nogués (14-10 al descanso). 2T: CUBA implacable de principio a fin. Mejoró en obtención y formaciones fijas. Tries: Mastroianni, Passaro, Castro Nevares x2 + penal Benedit. Atl. del Rosario deslucido, solo descontó con try Aime. Victoria con bonus CUBA 43-17, primer triunfo del torneo." },
  "26_06_7": { engañoso:"SÍ", motivo:"Muy parejo con marcador cambiante. Los Tilos tuvo ventaja numérica pero no pudo quebrar. CASI ganó con penal final de Akemeier.", amarillasL:1, amarillasV:0, champagne:"1T con muchas incidencias. CASI arriba con penal Akemeier, Los Tilos dio vuelta con try Guichón. CASI volvió al frente con 2 penales + try Torres Obeid. Los Tilos descontó con try Martínez Salgado. Larrague try sobre el cierre → CASI 23-14 al descanso. 2T: punto a punto. Los Tilos tuvo hombre de más por amarilla a Sánchez (CASI) pero no pudo quebrar la defensa. Santamarina penal → Los Tilos al frente (31-30). Akemeier penal sobre la hora → CASI 33-31. Primera vez que CASI jugó en casa tras fechas de suspensión. Akemeier autor de 18 tantos." },
  // FECHA 7
  "26_07_1": { engañoso:"SÍ", motivo:"BsAs 2 tarjetas (Reyes, Ibarra). Atl. del Rosario ganó con backs.", amarillasL:0, amarillasV:2, champagne:"1T parejo y entretenido, CASI fue arriba 12-7 al descanso. Los Matreros se mantuvo en partido con empuje de forwards y efectividad de Morales con el pie. En el 2T la igualdad se sostuvo hasta los últimos 20 minutos. Amarilla a Salinas fue el quiebre — CASI desplegó toda su potencia ofensiva y apoyó 7 tries para cerrar 48-24, goleada impensada hasta 10 minutos antes." },
  "26_07_2": { engañoso:"NO", motivo:"CUBA dominó 1T y ganó el partido. Los Tilos dominó 2T pero no alcanzó.", amarillasL:0, amarillasV:0, champagne:"CUBA dominó completamente el 1T con enorme efectividad en ataque. Cada aproximación terminaba en puntos. Tries: Corleto x2, Pisani, Castro Navares y Benedit → 36-7 al descanso. 2T: Los Tilos reaccionó anímicamente e impuso condiciones ante la baja de intensidad de CUBA. Tries: Chiavassa, Carruccio, Blaiotta Lago y Tuculet x2 + Santamarina en conversiones. CUBA sostuvo la diferencia gracias a la ventaja del 1T y Benedit (4 conv + 3 penales)." },
  "26_07_3": { engañoso:"SÍ", motivo:"Partido parejo hasta min 60. Amarilla a Salinas (Matreros) fue el quiebre.", amarillasL:0, amarillasV:1, champagne:"Atl. del Rosario impuso condiciones desde el inicio con contundencia en formaciones fijas y efectividad quirúrgica de Nogués. 1T dominante: Plaza sacó buena diferencia (40-14). En el 2T manejó las acciones con el partido liquidado para sumar bonus ofensivo. Buenos Aires peleó hasta el final y sumó 2 tries en el complemento pero no pudo acercarse." },
  "26_07_4": { engañoso:"SÍ", motivo:"Regatas ganó con roja de 20' a Sanguinetti. Sin esa tarjeta el partido pudo ser diferente.", amarillasL:1, amarillasV:0, champagne:"Partido trabado desde el inicio con muchas formaciones fijas. Belgrano sacó diferencia en el 1T (10-0) gracias a roja de Sanguinetti (min 26) → try de Arana + conversión Landó. 2T: Belgrano amplió a 15-0 con segundo try de Arana. Regatas reaccionó con tries de Rugolo y De la Torre (13-15). Belgrano tuvo 2 amarillas (Blacksley y Rebusone) pero resistió. Resultado final 15-13 defendiendo en los últimos 5 minutos." },
  "26_07_5": { engañoso:"SÍ", motivo:"La Plata dominó gran parte. SIC ganó por efectividad. La Plata 2 tarjetas (Bernasconi y Luna) en 2T.", amarillasL:0, amarillasV:2, champagne:"La Plata dominó en varios momentos pero la efectividad del SIC marcó la diferencia. Suárez Folch penal 3-0, Daireaux try → SIC 7-3. Addiechi try → La Plata 8-7. González Capdevilla try → SIC 14-8. Descanso 17-11 SIC. 2T: Addiechi otra vez → 17-16. Daireaux doblete → SIC 24-16. Silva try → SIC 31-16. Acosta try → SIC 38-19. Final: debutantes Festa y Defelitto 2 tries para La Plata, bonus defensivo y 38-31." },
  "26_07_6": { engañoso:"NO", motivo:"Newman ganó con 4 amonestados en el 2T. Hindú dominó 1T (22-10). Penal de Taboada en tiempo cumplido.", amarillasL:0, amarillasV:4, champagne:"Hindú dominó el 1T con ventaja 22-10 (tries Ormaechea, Rodríguez, Capurro + 2 conv y 2 penales). Newman arrancó arriba con try de Salese pero tuvo varios amonestados. 2T: Newman reaccionó con tries Ortiz Basualdo y Longinotti (22-20). Taboada penal → Newman 23-22. Rodríguez penal Hindú → 25-23. Newman recuperó pelota en salida, forzó infracción y Taboada selló 26-25 en la última jugada." },
  "26_07_7": { engañoso:"NO", motivo:"Alumni arrasó desde el 1T (33-0). Dominio total sin atenuantes.", amarillasL:0, amarillasV:0, champagne:"Alumni impuso condiciones desde el arranque con ritmo ofensivo arrollador. En el 1T apoyó 5 tries y se fue 33-0 al descanso sentenciando el encuentro. En el 2T continuó demoledor y en solo 10 minutos llegó al 50-0. Alumni cerró con 12 tries en total. Único descuento marista: try de Rojo convertido por Costaguta. Tries: Fuentes, Bivort, Fauve, Anderson + dobletes de F.Testoni, R.Testoni, Castanier y Cubilla." },
  // FECHA 8
  "26_08_2": { engañoso:"SÍ", motivo:"Alumni 3 amonestados (Alduncin, Cubilla, Bivort). Hindú ninguno. Patrón disciplina confirmado.", amarillasL:3, amarillasV:0, champagne:"Partido parejo 80min, Alumni siempre corrió desde atrás. Hindú golpeó con mayor contundencia: tries Cancelliere, Diviesti, Rodríguez + Ormaechea con el pie. Alumni 3 amonestados en distintos momentos. Alumni respondió con tries Bivort y Cozzi + Canzani. Hindú manejó mejor los tiempos finales. 1er triunfo de Hindú en Tortuguitas desde 2022." },
  "26_08_3": { engañoso:"SÍ", motivo:"La Plata dominó el 1T (12-3). Newman dio vuelta en el 2T con penales de Gutiérrez Taboada.", amarillasL:0, amarillasV:0, champagne:"La Plata dominó el 1T con 2 tries (Paz Rizzoli, Juliano) + conversión Defelitto (12-3). Newman no podía quebrar la sólida defensa canaria en el 2T. Salese try desde line-maul + Taboada conversión (13-12). Suárez Folch penal desde mitad de cancha → La Plata arriba (13-15). Scrum de Newman generó penal → Taboada 16-15 final." },
  "26_08_4": { engañoso:"PARCIAL", motivo:"Regatas 2 amarillas (Barbaccia, Cebrón) + try penal. Regatas quitó el bonus a SIC al final.", amarillasL:0, amarillasV:2, champagne:"SIC arrancó con 2 penales Sascaro. Regatas pasó al frente con try Landívar (line bien ejecutado). SIC recuperó: Acosta try + try penal por 2 amarillas Regatas (Barbaccia, Cebrón). 2T: Rocha, Meyrelles y González Capdevilla estiraron diferencia. Cierre: SIC bajó intensidad → Cebrón y De la Torre 2 tries consecutivos le quitaron el bonus ofensivo." },
  "26_08_7": { engañoso:"SÍ", motivo:"CASI ganó el 1T (23-7). CUBA dominó el 2T y casi da vuelta. CASI ganó con penal de Akemeier en tiempo cumplido.", amarillasL:0, amarillasV:0, champagne:"CASI mostró su mejor versión en el 1T (23-7). Tries: Torres Obeid, Sánchez, Castillo, Larrague + Akemeier. En el 2T CUBA cambió completamente con tries Irigaray, Cayol, Garoby x2 + Benedit. CUBA llegó a ganar 37-35 en el cierre. Akemeier penal en tiempo cumplido → 38-37 CASI." },
  "26_08_6": { engañoso:"PARCIAL", motivo:"1T parejo. Los Tilos dominó completamente el 2T. Amarilla a Rosasco (BsAs) y a F.Puertas (Los Tilos).", amarillasL:1, amarillasV:1, champagne:"1T equilibrado, BsAs fue arriba al descanso 15-10 (try Pizzo sobre el cierre). En el 2T Los Tilos salió decidido y cambió el partido por completo. Amarilla a Rosasco fue el quiebre. Martínez Salgado doblete, Blaiotta Lago, Gatti, San Sebastián y Cordero para la goleada." },
  "26_08_5": { engañoso:"SÍ", motivo:"Atl. del Rosario dominó el 1T con 2 tries. Belgrano dio vuelta en el 2T. Bonus defensivo para Atl. del Rosario.", amarillasL:0, amarillasV:0, champagne:"Belgrano intentó imponer el scrum, Plaza respondió con maul sólido. Atl. del Rosario dominó el 1T con tries Berter y Cornejo. Ceñal Barakat cambió el partido a los 20min del 2T con jugada colectiva. Pedro Arana try → Belgrano al frente por primera vez. Landó penal clave a 4min del final." },
  "26_08_1": { engañoso:"NO", motivo:"Los Matreros dominó el 1T (15-3). En el 2T tuvo 2 amarillas y aun así anotó. Genuinamente superior.", amarillasL:2, amarillasV:0, champagne:"Los Matreros aprovechó mejor sus oportunidades en el 1T con 2 tries vs solo penales de Costaguta (15-3). En el 2T Champagnat intentó reaccionar sin claridad. Los Matreros volvió a golpear con 2 tries más incluso con 2 amarillas propias. Bonus ofensivo sobre el cierre. Tries: García Michero, Amorisa, Salinas, Cec." },
};


// ── TAB ANÁLISIS ─────────────────────────────────────────────────
function TabAnalisis({arr}) {
  const fechas2026 = [...new Set(arr.filter(p=>p.t===2026).map(p=>p.f))].sort((a,b)=>b-a);
  const [fecha, setFecha] = useState(fechas2026[0]||8);
  const partidos = arr.filter(p=>p.t===2026&&p.f===fecha).sort((a,b)=>a.id.localeCompare(b.id));

  // Find context by matching local+visitante across all CONTEXTO keys for this fecha
  function getCtx(local, visitante) {
    const padF = String(fecha).padStart(2,'0');
    // Try all possible keys for this fecha
    for(let i=0;i<=9;i++){
      const k1=`26_0${fecha}_${i}`;
      const k2=`26_${padF}_${i}`;
      const ctx = CONTEXTO_PARTIDOS[k1]||CONTEXTO_PARTIDOS[k2];
      if(ctx) {
        // Check motivo contains team name clue - use positional match instead
        return ctx; // fallback: return by position
      }
    }
    return null;
  }

  // Build ordered ctx list matching partidos order
  function getCtxOrdered() {
    const padF = String(fecha).padStart(2,'0');
    const keys = Object.keys(CONTEXTO_PARTIDOS)
      .filter(k=>k.startsWith(`26_0${fecha}_`)||k.startsWith(`26_${padF}_`))
      .sort();
    return keys.map(k=>({key:k, ...CONTEXTO_PARTIDOS[k]}));
  }

  const ctxList = getCtxOrdered();

  const METRICS = [
    {k:'try',l:'Try'},{k:'c',l:'C'},{k:'d',l:'D'},{k:'pk',l:'PK'},
    {k:'lb',l:'LB'},{k:'off',l:'Off'},{k:'m52',l:'52'},{k:'t',l:'T'},
    {k:'tg',l:'TG'},{k:'l',l:'L'},{k:'st',l:'ST'},
    {k:'amarilla',l:'🟡'},{k:'roja',l:'🔴'},{k:'pc',l:'PC'},
    {k:'te',l:'TE'},{k:'ko',l:'KO'}
  ];
  ...
  return (
    <div style={{padding:18}}>
      ...
      <div style={{display:"flex",gap:8,flexWrap:"wrap",marginBottom:20,alignItems:"center"}}>
        ...
        {fechas2026.map(f=>(
          <button key={f} onClick={()=>setFecha(f)}
            style={{padding:"5px 14px",borderRadius:20,border:"1px solid",cursor:"pointer",
              fontSize:12,fontWeight:600,
              background:fecha===f?"#0f3460":"#f8fafc",
              color:fecha===f?"#fff":"#64748b",
              borderColor:fecha===f?"#0f3460":"#e2e8f0"}}>
            F{f}
          </button>
        ))}
      </div>
      ...
      <div style={{display:"flex",flexDirection:"column",gap:16}}>
        {partidos.map((p,idx)=>{
          const ctx = ctxList[idx]||null;
          const engColor = !ctx?"#94a3b8":ctx.engañoso==="NO"?"#16a34a":ctx.engañoso==="SÍ"?"#dc2626":"#f59e0b";
          const engBg   = !ctx?"#f8fafc":ctx.engañoso==="NO"?"#dcfce7":ctx.engañoso==="SÍ"?"#fee2e2":"#fef3c7";
          const engLabel= !ctx?"Sin datos":ctx.engañoso==="NO"?"✓ Resultado real":ctx.engañoso==="SÍ"?"⚠ Engañoso":"~ Parcial";

          return (
            <div key={p.id} style={{border:"1px solid #e2e8f0",borderRadius:12,overflow:"hidden",boxShadow:"0 1px 4px rgba(0,0,0,0.06)"}}>

              {/* Header */}
              <div style={{background:"#0f3460",padding:"10px 16px",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                <div style={{color:"#fff",fontWeight:700,fontSize:14}}>
                  {p.local} <span style={{color:"#a3c4f3",fontWeight:400,fontSize:12,margin:"0 6px"}}>vs</span> {p.visitante}
                </div>
                <div style={{color:"#fff",fontWeight:800,fontSize:16,letterSpacing:1}}>
                  {p.pL} — {p.pV}
                  {p.bL&&<span style={{fontSize:10,marginLeft:5,color:"#fde68a"}}>(B)</span>}
                  {p.bV&&<span style={{fontSize:10,marginLeft:5,color:"#fde68a"}}>(B)</span>}
                </div>
              </div>

              {/* ESPN + Champagne */}
              <div style={{display:"grid",gridTemplateColumns:"1fr 2fr",gap:0,borderBottom:"1px solid #e2e8f0"}}>

                {/* ESPN — compacto */}
                <div style={{padding:"10px 14px",borderRight:"1px solid #e2e8f0",background:"#f8fafc"}}>
                  <div style={{fontSize:10,fontWeight:700,color:"#0f3460",marginBottom:6,letterSpacing:1}}>📰 ESPN</div>
                  <span style={{display:"inline-block",fontSize:10,padding:"2px 8px",borderRadius:10,
                    background:engBg,color:engColor,fontWeight:700,marginBottom:6}}>
                    {engLabel}
                  </span>
                  {ctx&&(ctx.amarillasL>0||ctx.amarillasV>0)&&(
                    <div style={{fontSize:10,color:"#92400e",marginBottom:4}}>
                      🟡 {p.local}: {ctx.amarillasL} · {p.visitante}: {ctx.amarillasV}
                    </div>
                  )}
                  {ctx&&<div style={{fontSize:11,color:"#374151",lineHeight:1.5}}>{ctx.motivo}</div>}
                </div>

                {/* Champagne — más espacio */}
                <div style={{padding:"10px 14px",background:"#fff"}}>
                  <div style={{fontSize:10,fontWeight:700,color:"#7c3aed",marginBottom:6,letterSpacing:1}}>Fuente externa (Rugby Champagne)</div>
                  {ctx?.champagne
                    ? <div style={{fontSize:11,color:"#374151",lineHeight:1.6}}>{ctx.champagne}</div>
                    : <div style={{fontSize:11,color:"#94a3b8",fontStyle:"italic"}}>Sin análisis cargado aún</div>
                  }
                </div>
              </div>
              ...
              {/* Datos Técnicos */}
              {(()=>{
                const dt = DATOS_TECNICOS[p.id];
                return (
                  <div style={{padding:"10px 14px",background:"#f8fafc"}}>
                    <div style={{fontSize:10,fontWeight:700,color:"#16a34a",marginBottom:8,letterSpacing:1}}>📊 DATOS TÉCNICOS</div>
                    {dt ? (
                      <div style={{overflowX:"auto"}}>
                        <table style={{width:"100%",borderCollapse:"collapse",fontSize:11}}>
                          <thead>
                            <tr style={{background:"#0f3460"}}>
                              <th style={{padding:"5px 10px",textAlign:"left",color:"#fff",fontWeight:600,minWidth:110,position:"sticky",left:0,background:"#0f3460"}}>Equipo</th>
                              {METRICS.map(m=>(
                                <th key={m.k} style={{padding:"5px 8px",textAlign:"center",color:"#fff",fontWeight:600,minWidth:32}}>{m.l}</th>
                              ))}
                            </tr>
                          </thead>
                          <tbody>
                            {[{name:p.local,datos:dt.local},{name:p.visitante,datos:dt.visit}].map((eq,i)=>(
                              <tr key={i} style={{background:i===0?"#fff":"#f0f9ff",borderBottom:"1px solid #e2e8f0"}}>
                                <td style={{padding:"5px 10px",fontWeight:700,color:"#0f3460",position:"sticky",left:0,background:i===0?"#fff":"#f0f9ff",fontSize:11}}>{eq.name}</td>
                                {METRICS.map(m=>{
                                  const val = eq.datos?.[m.k];
                                  const isHigh = (m.k==='lb'&&val>=8)||(m.k==='tg'&&val>=15)||(m.k==='amarilla'&&val>=2)||(m.k==='pc'&&val>=10);
                                  const isLow = m.k==='try'&&val===0;
                                  return (
                                    <td key={m.k} style={{padding:"5px 8px",textAlign:"center",
                                      color:isHigh?"#dc2626":isLow?"#94a3b8":"#374151",
                      ...
                      <div style={{fontSize:11,color:"#94a3b8",fontStyle:"italic"}}>Sin datos técnicos cargados aún</div>
                    )}
                  </div>
                );
              })()}
...
const DATOS_TECNICOS = {
  "26_08_1": {local:{try:0,c:0,d:0,pk:3,lb:4,off:0,m52:0,t:86,tg:11,l:9,st:0,amarilla:0,roja:0,pc:6,te:7,ko:10},visit:{try:4,c:2,d:0,pk:2,lb:4,off:1,m52:0,t:57,tg:3,l:11,st:0,amarilla:2,roja:0,pc:5,te:9,ko:8}},
  "26_08_2": {local:{try:2,c:1,d:0,pk:2,lb:3,off:0,m52:0,t:115,tg:12,l:10,st:0,amarilla:3,roja:0,pc:8,te:18,ko:6},visit:{try:3,c:1,d:0,pk:2,lb:9,off:0,m52:0,t:78,tg:13,l:5,st:0,amarilla:1,roja:0,pc:4,te:4,ko:6}},
  "26_08_3": {local:{try:1,c:1,d:0,pk:2,lb:11,off:0,m52:0,t:77,tg:15,l:7,st:1,amarilla:2,roja:0,pc:7,te:11,ko:10},visit:{try:2,c:0,d:0,pk:1,lb:6,off:1,m52:1,t:106,tg:20,l:11,st:1,amarilla:0,roja:0,pc:4,te:15,ko:9}},
  "26_08_4": {local:{try:5,c:3,d:0,pk:2,lb:2,off:0,m52:0,t:69,tg:8,l:11,st:0,amarilla:1,roja:0,pc:9,te:11,ko:5},visit:{try:3,c:3,d:0,pk:0,lb:4,off:1,m52:0,t:84,tg:8,l:8,st:1,amarilla:2,roja:0,pc:10,te:11,ko:2}},
  "26_08_5": {local:{try:3,c:2,d:0,pk:2,lb:2,off:2,m52:0,t:67,tg:10,l:6,st:0,amarilla:1,roja:0,pc:7,te:6,ko:7},visit:{try:2,c:1,d:0,pk:3,lb:4,off:2,m52:1,t:101,tg:12,l:7,st:0,amarilla:1,roja:0,pc:9,te:10,ko:3}},
  "26_08_6": {local:{try:3,c:1,d:0,pk:1,lb:7,off:2,m52:0,t:95,tg:11,l:5,st:0,amarilla:1,roja:0,pc:11,te:7,ko:2},visit:{try:7,c:5,d:0,pk:1,lb:3,off:1,m52:2,t:78,tg:12,l:9,st:1,amarilla:1,roja:0,pc:8,te:14,ko:6}},
  "26_08_7": {local:{try:4,c:4,d:0,pk:3,lb:7,off:2,m52:1,t:62,tg:14,l:5,st:0,amarilla:0,roja:0,pc:8,te:3,ko:5},visit:{try:4,c:3,d:0,pk:4,lb:4,off:0,m52:0,t:104,tg:21,l:11,st:0,amarilla:0,roja:0,pc:9,te:5,ko:7}},
};
...
const FORMACIONES = {
  ...
  8: {
    fecha: 8, d: "2026-05-16",
    equipos: {
      "Alumni":          { j:["Juan Cruz Bottoni","Tomás Bivort","Francisco Bottoni","Manuel Mora","Santiago Alduncin","Ignacio Cubilla","Patricio Anderson","Santiago Neyra","Tomás Passerotti","Bautista Canzani","Mateo Castanier","Filippo Testoni","Tomás Cubilla","Ramón Fuentes","Matías Del Franco"], c:null },
      "Hindú":           { j:["Juan Ignacio Martínez Sosa","Agustín Capurro","Franco Diviesti","Tomás Scallan","Juan Comolli","Santino Amaya","Lautaro Bávaro","Nicolás Amaya","Felipe Ezcurra","Fermín Ormaechea","Martín Sulam","Ramón Fernández Miranda","Lisandro Rodríguez","Tomás Amher","Sebastián Cancelliere"], c:null },
      "Newman":          { j:["James Wright","Beltrán Salese","Bautista Bosch","Francisco Lascombes","Pablo Fortín","Teófilo Garay","Joaquín de la Vega","Rodrigo Díaz de Vivar","Facundo Torello","Gonzalo Gutiérrez Taboada","Justo Ortíz Basualdo","Tomás Keena","Cruz Ulloa","Franco Lomginotti","Juan Bautista Daireaux"], c:null },
      "La Plata":        { j:["Martin Patat","Juan Martín Fontán","Ignacio Luna","Bautista Ozog","Iván Kucic","Francisco Ringuelet","Segundo Pineda","Tomás Bernasconi","Manuel de la Fuente","Facundo Defelito","Pedro Addiechi","Francisco Paz Rizzoli","Luca Juliano","Gino Festa","Francisco Annecchini"], c:"Tomás Bernasconi" },
      "SIC":             { j:["Francisco Calandra","Lucas Rocha","Benjamín Chiappe","Ciro Plorutti","Tomás Longo","Andrea Panzarini","Santos Fernández De Oliveira","Alejandro Daireaux","Mateo Albanese","Agustín Sascaro","Bernabé López Fleming","Santos Rubio","Nicanor Acosta","Timoteo Silva","Francisco González Capdevilla"], c:"Mateo Albanese" },
      "Regatas":         { j:["Tomás Barbaccia","Beltrán Landivar","Bautista Solveyra","Bautista López Mañan","Tomás Sanguinetti","Lucas Gobet","Santiago Ruiz","Felipe Camerlinckx","Esteban de la Torre","José de la Torre","Enrique Camerlinckx","Ramiro Moadeb","Tobías Klapenbach","Felipe Rugolo","Justo Camerlinckx"], c:null },
      "Buenos Aires":    { j:["Tomás Gallo","Tomás Rosasco","Renzo Zanella","Francisco Syriani","Tomás Álvarez Bayón","Matías Espina","Simón Mimessi","Juan Segundo Campbell","Mateo Freire","Mateo Capalbo","Julián Quetglas","Marcos Deges","Luis Prieto Martínez","Benjamín Handley","Nicolás Pizzo"], c:"Mateo Freire" },
      "Los Tilos":       { j:["Manuel Puertas","Cosme Carruccio","Facundo Maffei","Luciano Torboli","Martin Leiva","Eliseo Chiavassa","Felipe Puertas","Bautista Gatti","Pedro Rodriguez Alcobendas","Joaquin Tuculet","Gaston Martinez Salgado","Tomás Fernandez Armendariz","Thiago Bassagaisteguy","Ignacio Guichon","Bautista Santamarina"], c:null },
      "Champagnat":      { j:["Alberto Adissi","Simón Panelo","Tomás Yanzón","Tobías Rivas Orozco","Santiago Escuti","Matías Jesús Alonso Boto","Francisco Castelli","Nicolás Rojo","Pedro Del Piano","Simón De Olmos","Bautista Rodríguez Navarro","Simón Villanueva","Tomás Cotter Daireaux","Simón Zappella","Gonzalo Costaguta"], c:null },
      "Los Matreros":    { j:["Matías Salina","Boris Cec","Valentín Hardt","Tomas Gahan","Juan Pablo Guevara","Agustín Córdoba","Colin McCormack","Santiago Villarino","Marcos Amorisa","Juan Francisco Morales","Santiago Marelli","Pedro Del Busto","Nicolás Santecchia","German Gallastegui","Juan Pablo García Michero"], c:"Santiago Villarino" },
      "Belgrano Ath.":   { j:["Francisco Ferronato","Santiago Villegas","Eliseo Marchetti","Ramón Duggan","Luciano Tecca","Francisco Gradín","Julián Rebusone","Augusto Vaccarino","Theo Blacksley","Juan Landó","Bautista Fossati","Martín Arana","Juan Brescia","Pedro Arana","Nicolás Spinelli"], c:"Julián Rebusone" },
      "Atl. del Rosario":{ j:["Ezequiel Reyes","Ramiro Rubio","Bruno Montenegro","José Cáceres","Octavio Capella","Federico Etcheverry","Ignacio Sapino","Lucas Malanos","Tomás Cornejo","Manuel Nogués","Nicolás Casals","Santiago Vitola","Tomás Malanos","Juan Cruz Bertero","Martín Elías"], c:"Tomás Malanos" },
      "CUBA":            { j:["Francisco Garoby","Juan Pedro Garoby","Esteban Iribarne","Santiago Uriarte","Santos Cayol","Juan Capdepont","Segundo Pisani","Benito Ortíz de Rosas","Félix Corleto","Valentín Mastroizzi","Pedro Castro Nevares","Rafael Benedit","Felipe de la Vega","Bautista Casaurang","Iñaki Irigaray"], c:null },
      "CASI":            { j:["Facundo Scaiano","Juan Bautista Torres Obeid","Félix Paolucci","Ignacio Torrado","Ignacio Larrague","Eugenio Sartori","Joaquín Saenz de Miera","Benjamín Rocca Rivarola","Joaquín Sánchez","Felipe Hileman","Ramón Castillo","Jerónimo Solveyra","Benjamín Belaga","Tomás Phelan","Juan Akemeier"], c:null },
    }
  },
  9: {
    fecha: 9, d: "2026-05-23",
    equipos: {
      "Los Tilos":       { j:["Manuel Puertas","Cosme Carruccio","Facundo Maffei","Luciano Torboli","Martin Leiva","Eliseo Chiavassa","Felipe Puertas","Bautista Gatti","Tomas Vardé","Joaquin Tuculet","Gaston Martinez Salgado","Thiago Bassagaisteguy","Matias Cordero","Ignacio Guichon","Bautista Santamarina"], c:null },
      "Belgrano Ath.":   { j:["Francisco Ferronato","Santiago Villegas","Lisandro García Dragui","Mauro Rebussone","Ramón Duggan","Francisco Gradín","Julián Rebussone","Augusto Vaccarino","Theo Blacksley","Juan Landó","Félix Ceñal","Martín Arana","Juan Brescia","Pedro Arana","Nicolás Spinelli"], c:"Julián Rebussone" },
      "Atl. del Rosario":{ j:["Ezequiel Reyes","Ramiro Rubio","Bruno Montenegro","José Cáceres","Octavio Capella","Federico Etcheverry","Ignacio Sapino","Lucas Malanos","Tomás Cornejo","Manuel Nogués","Nicolás Casals","Santiago Vitola","Tomás Malanos","Juan Cruz Bertero","Martín Elías"], c:"Tomás Malanos" },
      "SIC":             { j:["Francisco Calandra","Lucas Rocha","Benjamín Chiappe","Ciro Plorutti","Manuel Curuchaga","Andrea Panzarini","Santos Fernández De Oliveira","Tomás Meyrelles","Mateo Albanese","Agustín Sascaro","Bernabé López Fleming","Santos Rubio","Nicanor Acosta","Timoteo Silva","Francisco González Capdevilla"], c:"Mateo Albanese" },
      "Regatas":         { j:["Tomás Barbaccia","Beltrán Landivar","Juan Manuel Gobet","Tomás Sanguinetti","Bautista López Mañan","Marcos Ferro","Lucas Gobet","Felipe Camerlinckx","Marcos Joseph","José de la Torre","Enrique Camerlinckx","Tobías Klapenbach","Francisco Pisani","Felipe Rugolo","Justo Camerlinckx"], c:null },
      "Newman":          { j:["Miguel Prince","Beltrán Salese","Bautista Bosch","Francisco Lascombes","Pablo Fortín","Mateo Montoya","Joaquín de la Vega","Rodrigo Díaz de Vivar","Lucas Nava","Gonzalo Gutiérrez Taboada","Justo Ortíz Basualdo","Benjamín Lanfranco","Cruz Ulloa","Franco Lomginotti","Juan Bautista Daireaux"], c:null },
      "La Plata":        { j:["Ariel Del Cerro","Joaquín Núñez","Ignacio Luna","Iván Kucic","Bautista Ozog","Francisco Ringuelet","Segundo Pineda","Nicolás Chiappani","Manuel de la Fuente","Facundo Defelito","Gino Festa","Francisco Paz Rizzoli","Luca Juliano","Pedro Addiechi","Tomás Suárez Folch"], c:null },
      "Alumni":          { j:["Juan Cruz Bottoni","Tomás Bivort","Francisco Bottoni","Manuel Mora","Sebastián Fauve","Ignacio Cubilla","Patricio Anderson","Santiago Neyra","Rocco Testoni","Bautista Canzani","Mateo Castanier","Filippo Testoni","Tomás Cubilla","Ramón Fuentes","Matías Del Franco"], c:null },
      "Hindú":           { j:["Facundo Gattas","Agustín Capurro","Franco Divesti","Tomás Scallan","Juan Comolli","Santino Amaya","Lautaro Bávaro","Nicolás Amaya","Felipe Ezcurra","Fermín Ormaechea","Martín Sulam","Ramón Fernández Miranda","Lisandro Rodríguez","Tomás Amher","Sebastián Cancelliere"], c:"Felipe Ezcurra" },
      "Champagnat":      { j:["Alberto Adissi","Fernando Rodríguez Pascarella","Marcos Magaró","Tobías Rivas Orozco","Santiago Escuti","Matías Jesús Alonso Boto","Tomás Alonso Boto","Conrado Sierra","Pedro Del Piano","Pedro Roquette","Bautista Rodríguez Navarro","Simón Villanueva","Tomás Cotter Daireaux","Simón Zappella","Gonzalo Costaguta"], c:null },
      "CASI":            { j:["Facundo Scaiano","Juan Ignacio Albareda","Félix Paolucci","Salvador Ochoa","Ignacio Larrague","Ignacio Torrado","Joaquin Saenz de Miera","Benjamín Rocca Rivarola","Joaquin Sanchez","Felipe Hileman","Ramon Castillo","Jeronimo Solveyra","Benjamin Belaga","Tomas Phelan","Juan Akemeier"], c:null },
      "Buenos Aires":    { j:["Tomás Herrador","Tomás Rosasco","Tomás Gallo","Francisco Syriani","Tomás Álvarez Bayón","Octavio Bartolome","Simón Mimessi","Juan Segundo Campbell","Mateo Freire","Mateo Capalbo","Felipe Mascolo","Marcos Deges","Luis Prieto Martínez","Benjamín Handley","Nicolás Pizzo"], c:"Mateo Freire" },
      "Los Matreros":    { j:["Matías Salina","Boris Cec","Juan Pablo Zeiss","Tomás Gahan","Juan Pablo Guevara","Agustín Córdoba","Agustín Antar","Santiago Villarino","Marcos Amorisa","Juan Francisco Morales","Santiago Marelli","Pedro del Busto","Nicolás Santecchia","German Gallastegui","Juan Pablo García Michero"], c:"Santiago Villarino" },
      "CUBA":            { j:["Joaquin Yakiche","Juan Pedro Garoby","Esteban Iribarne","Santiago Uriarte","Santos Cayol","Juan Capdepont","Segundo Pisani","Benito Ortíz de Rosas","Félix Corleto","Valentín Mastroizzi","Pedro Castro Nevares","Rafael Benedit","Felipe de la Vega","Bautista Casaurang","Iñaki Irigaray"], c:null },
    }
  },
};
...
function TabFormaciones() {
  const [rotDetalle, setRotDetalle] = useState(null);
                      ...
                      <div style={{marginBottom:16}}>
                        ...
                        <div>
                          <div style={{display:"flex",gap:6,flexWrap:"wrap",marginBottom:6}}>
                            {rotaciones.map(r=>{
                              const activo = rotDetalle===r.f;
                              return (
                                <div key={r.f}
                                  onClick={()=>setRotDetalle(activo?null:r.f)}
                                  style={{padding:"4px 10px",borderRadius:6,fontSize:11,fontWeight:600,cursor:"pointer",
                                    transition:"all 0.15s",
                                    background:activo?"#0f3460":r.cambios<=2?"#f0fdf4":r.cambios<=4?"#fef3c7":r.cambios<=6?"#fee2e2":"#fecaca",
                                    color:activo?"#fff":r.cambios<=2?"#166534":r.cambios<=4?"#92400e":r.cambios<=6?"#991b1b":"#7c1d1d",
                                    border:"1px solid",
                                    borderColor:activo?"#0f3460":r.cambios<=2?"#bbf7d0":r.cambios<=4?"#fde68a":r.cambios<=6?"#fca5a5":"#f87171"}}>
                          ...
                          {rotDetalle&&(()=>{
                            const r = rotaciones.find(x=>x.f===rotDetalle);
                            if(!r) return null;
                            const fAnt = FORMACIONES[r.fechaAnterior]?.equipos[selectedEquipo];
                            const fAct = FORMACIONES[r.f]?.equipos[selectedEquipo];
                            if(!fAnt||!fAct) return null;
                            const normR = n=>(n||"").split(" ").slice(-1)[0].toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"");
                            const posNombres=["1-Pilar","2-Hooker","3-Pilar","4-2da línea","5-2da línea","6-Ala","7-Ala","8-Octavo","9-SH","10-Apertura","11-Wing","12-Centro","13-Centro","14-Wing","15-Fullback"];
                            const posClave=new Set([1,7,8,9,14]);
                            const diffs=fAnt.j.map((j,i)=>normR(j)!==normR(fAct.j[i])?{i,ant:j,act:fAct.j[i]}:null).filter(Boolean);
                            return (
                              <div style={{background:"#f8fafc",border:"1px solid #e2e8f0",borderRadius:8,padding:"10px 14px",marginTop:4}}>
                                <div style={{fontSize:11,fontWeight:700,color:"#0f3460",marginBottom:8}}>
                                  Cambios F{r.fechaAnterior} → F{r.f}
                                </div>
                                {diffs.map(d=>(
                                  <div key={d.i} style={{display:"flex",gap:8,alignItems:"center",marginBottom:4,fontSize:11}}>
                                    <span style={{color:"#64748b",minWidth:80}}>{posNombres[d.i]}</span>
                                    {posClave.has(d.i)&&<span style={{fontSize:9,padding:"1px 5px",background:"#fee2e2",color:"#dc2626",borderRadius:3,fontWeight:700}}>CLAVE</span>}
                                    <span style={{color:"#dc2626",textDecoration:"line-through"}}>{d.ant}</span>
                                    <span style={{color:"#64748b"}}>→</span>
                                    <span style={{color:"#16a34a",fontWeight:600}}>{d.act}</span>
                                  </div>
                                ))}
                              </div>
                            );
                ...
                return (
                  <div key={t.id} style={{background:"#f8fafc",border:"1px solid #e2e8f0",borderRadius:10,padding:"12px 14px",marginBottom:8}}>
                    ...
                    <div style={{display:"flex",gap:8,alignItems:"center",flexWrap:"wrap"}}>
                        ...
                        {t.resultado?(
                          <>
                            <span style={{padding:"4px 12px",borderRadius:6,background:"#dcfce7",color:"#166534",fontSize:12,fontWeight:700,border:"1px solid #16a34a"}}>
                              {t.resultado==="L"?"Ganó "+t.local:t.resultado==="V"?"Ganó "+t.visitante:"Empate"}
                            </span>
                            <button onClick={()=>setResultado(t.id,null)}
                              style={{padding:"4px 10px",borderRadius:6,border:"1px solid #e2e8f0",background:"#f8fafc",cursor:"pointer",fontSize:11,color:"#64748b"}}>
                              ✏️ Editar
                            </button>
                          </>
                        ):(
...
export default function App() {
  ...
  return (
    <div style={S.root}>
      ...
      <div style={S.tbar}>
        {["Resultados","Tabla","Localía","H2H","Predictor","Cuotas","Formaciones","Análisis"].map(t=>(
      ...
      <div style={S.body}>
        ...
        {tab==="Análisis"&&<TabAnalisis arr={partidos}/>}
      </div>
    </div>
  );
}
